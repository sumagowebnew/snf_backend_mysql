...
const fs = require("fs");
const recordModel = require("../models/shahidjawanModel");
...
function getshahidjawanRecord(req, res) {
  try {
...
function createshahidjawanRecord(req, res) {
  try {
...
function updateshahidjawanRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
...
function deleteshahidjawanRecord(req, res) {
  try {
    const { id } = req.params;
