...
const fs = require("fs");
const recordModel = require("../models/wellwishersModel");
...
function getwellwishersRecord(req, res) {
  try {
...
function createwellwishersRecord(req, res) {
  try {
...
function updatewellwishersRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
...
function deletewellwishersRecord(req, res) {
  try {
    const { id } = req.params;
