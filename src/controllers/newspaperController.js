...
const fs = require("fs");
const recordModel = require("../models/newspaperModel");
...
function getnewspaperRecord(req, res) {
  try {
...
function createnewspaperRecord(req, res) {
  try {
...
function updatenewspaperRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
...
function deletenewspaperRecord(req, res) {
  try {
    const { id } = req.params;
