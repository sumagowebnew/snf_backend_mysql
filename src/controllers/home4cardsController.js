...
const fs = require("fs");
const recordModel = require("../models/home4cardsModel");
...
function gethome4cardsRecord(req, res) {
  try {
...
function createhome4cardsRecord(req, res) {
  try {
...
function updatehome4cardsRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
...
function deletehome4cardsRecord(req, res) {
  try {
    const { id } = req.params;
