...
const fs = require("fs");
const recordModel = require("../models/envconservationModel");
...
function getenvconservationRecord(req, res) {
  try {
...
function createenvconservationRecord(req, res) {
  try {
...
function updateenvconservationRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
...
function deleteenvconservationRecord(req, res) {
  try {
    const { id } = req.params;
