...
const fs = require("fs");
const recordModel = require("../models/sportprojectModel");
...
function getsportprojectRecord(req, res) {
  try {
...
function createsportprojectRecord(req, res) {
  try {
...
function updatesportprojectRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
...
function deletesportprojectRecord(req, res) {
  try {
    const { id } = req.params;
