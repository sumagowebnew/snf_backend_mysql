...
const fs = require("fs");
const recordModel = require("../models/NRIparticipantModel");
...
function getnriparticipantRecord(req, res) {
  try {
...
function createnriparticipantRecord(req, res) {
  try {
...
function updatenriparticipantRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
...
function deletenriparticipantRecord(req, res) {
  try {
    const { id } = req.params;
