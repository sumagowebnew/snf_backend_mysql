...
const fs = require("fs");
const recordModel = require("../models/homeMediaModel");
...
function gethomeMediaRecord(req, res) {
  try {
...
function createhomeMediaRecord(req, res) {
  try {
...
function updatehomeMediaRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
...
function deletehomeMediaRecord(req, res) {
  try {
    const { id } = req.params;
