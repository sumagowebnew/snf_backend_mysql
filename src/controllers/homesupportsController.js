...
const fs = require("fs");
const recordModel = require("../models/homesupportsModel");
...
function gethomesupportsRecord(req, res) {
  try {
...
function createhomesupportsRecord(req, res) {
  try {
...
function updatehomesupportsRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
...
function deletehomesupportsRecord(req, res) {
  try {
    const { id } = req.params;
