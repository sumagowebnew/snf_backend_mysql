...
const fs = require("fs");
const recordModel = require("../models/cleanwaterModel");
...
function getcleanwaterRecord(req, res) {
  try {
...
function createcleanwaterRecord(req, res) {
  try {
...
function updatecleanwaterRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
...
function deletecleanwaterRecord(req, res) {
  try {
    const { id } = req.params;
