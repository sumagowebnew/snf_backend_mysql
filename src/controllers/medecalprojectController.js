...
const fs = require("fs");
const recordModel = require("../models/healthmedicalModel");
...
function getmedecalprojectRecord(req, res) {
  try {
...
function createmedecalprojectRecord(req, res) {
  try {
...
function updatemedecalprojectRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
...
function deletemedecalprojectRecord(req, res) {
  try {
    const { id } = req.params;
