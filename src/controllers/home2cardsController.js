...
const fs = require("fs");
const recordModel = require("../models/home2cardsModel");
...
function gethome2cardsRecord(req, res) {
  try {
...
function createhome2cardsRecord(req, res) {
  try {
...
function updatehome2cardsRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
...
function deletehome2cardsRecord(req, res) {
  try {
    const { id } = req.params;
