...
const fs = require("fs");
const recordModel = require("../models/stateparticipantsModel");
...
function getstateparticipantRecord(req, res) {
  try {
...
function createstateparticipantRecord(req, res) {
  try {
...
function updatestateparticipantRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
...
function deletestateparticipantRecord(req, res) {
  try {
    const { id } = req.params;
