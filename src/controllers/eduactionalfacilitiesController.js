...
const fs = require("fs");
const recordModel = require("../models/educationalfacilitiesModel");
...
function geteduactionalfacilitiesRecord(req, res) {
  try {
...
function createeduactionalfacilitiesRecord(req, res) {
  try {
...
function updateeduactionalfacilitiesRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
...
function deleteeduactionalfacilitiesRecord(req, res) {
  try {
    const { id } = req.params;
