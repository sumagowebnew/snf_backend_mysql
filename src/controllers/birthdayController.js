...
const fs = require("fs");
const recordModel = require("../models/birthdayModel");
...
function getbirthdayRecord(req, res) {
  try {
...
function createbirthdayRecord(req, res) {
  try {
...
function updatebirthdayRecord(req, res) {
  try {
    const { id } = req.params;
    const recordData = req.body;
...
function deletebirthdayRecord(req, res) {
  try {
    const { id } = req.params;
